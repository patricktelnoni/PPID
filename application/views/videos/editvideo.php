        ...
        <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Harus diisi</strong></div>
                ...
                <div class="col-lg-8 form-group">
                   <div class="col-md-3"> <label for="InputName">Judul</label></div>
                    ...
                    <div class="col-lg-8 input-group">
                        <input type="text" class="form-control" name="title" id="InputName" placeholder="Masukan nama" value="<?=$row->title?>" required>
                ...
                <div class="col-lg-8 form-group">
                   <div class="col-md-3"> <label for="InputName">Link</label></div>
                    ...
                    <div class="col-lg-8 input-group">
                        <input type="text" class="form-control" name="link" id="InputName" placeholder="Masukan Link video berupa url"  value="<?=$row->link?>" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                   
                </div>
                <div class="col-lg-8 form-group" style="visibility: hidden;">
                   <div class="col-md-3"> <label for="InputName">id</label></div>
                   
                    <div class="col-lg-8 input-group">
                        <input type="text" class="form-control" name="videoid" id="InputName" placeholder="Masukan Link video berupa url"  value="<?=$row->videoid?>" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
