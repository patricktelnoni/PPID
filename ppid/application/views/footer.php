...
<!-- BAGIAN FOOTER -->        
        <div class="footer">
        	<div>
		        ...
		        <div style="font-size:10px;color:#000; float:right; text-align:center; padding:6px 10px 5px 0">
					Copyright: <a style="color:#000" href="http://www.perkantasjatim.org">Departemen Multimedia Perkantas Jawa Timur, 2010</a></span>
		        </div>
                <div class="clearboth">
                </div>                        
